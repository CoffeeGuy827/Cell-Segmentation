...
class DataBowl2018Experiment(BaseExperiment) :
    def __init__(self, data_type, dataset_dir, train_frame, val_frame, test_frame, image_size, batch_size, num_workers,
        ...
        super(DataBowl2018Experiment, self).__init__(model_name, num_classes, self.num_channels, optimizer, criterion,
    ...
    def inference(self):
        ...
        with torch.no_grad() :
            ...
            for batch_idx, (image, target) in enumerate(self.test_loader) :
                ...
                total_loss += loss.item()
                acc, pre, rec, f1, iou = metrics(target, predict)
        ...
        return test_loss, accuracy, precision, recall, f1_score, iou
