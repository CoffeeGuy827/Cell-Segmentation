...
def save_metrics(test_results, model_dirs, save_model_path) :
    test_loss, accuracy, precision, recall, f1_score, iou = test_results

    print("###################### TEST REPORT ######################")
    print("FINAL TEST loss : {} | accuracy : {} | precision : {} | recall : {} | f1_score : {} | iou : {}".format(
        test_loss, accuracy, precision, recall, f1_score, iou
    ))
    print("###################### TEST REPORT ######################")
...
def save_total_metrics(**kwargs) :
    loss, acc, pre, rec, f1, iou, save_path = load_total_metric_results(**kwargs)
